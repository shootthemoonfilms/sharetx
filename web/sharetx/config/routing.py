...
def make_map():
    ...
    map.connect('project', '/project/:uri/:revision/download/{filename:.*}', controller='project', action='download')
    map.connect('project', '/project/:uri/:revision/share/{action}', controller='share')
