...
function readFile (path) {
  ...
  try {
    ...
    var sis = getScriptableInputStream(is);
...
var Cx = {
  ...
  get PUBLISH_SERVER () { return getCeltxService().PUBLISH_SERVER; },
  get SERVER_BASEURL () { return 'https://' + this.PUBLISH_SERVER },

  get REGISTER_URL   () { return this.SERVER_BASEURL + '/pub/register/check/' },
  get STARTUP_URL    () { return this.SERVER_BASEURL + '/pub/startup' },
  get SPLASH_URL     () { return this.SERVER_BASEURL + '/pub/splash' },

  get USERLIST_URL   () { return this.SERVER_BASEURL + '/pub/find-users/' },
  get SYNC_URL       () { return this.SERVER_BASEURL + '/app/sync' },
  get PROJ_LIST_URL  () { return this.SERVER_BASEURL + '/app/projlist' },
  get AUTH_URL       () { return this.SERVER_BASEURL + '/app/test-auth' },
  get PDF_CONVERT_URL() { return 'https://render.celtx.com/as/pdf' },
  get PDF_PREVIEW_URL() { return 'https://render.celtx.com/as/html' },
  get PRESYNC_URL    () { return this.SERVER_BASEURL + '/app/ui/presync/' },
  get WEBPANEL_URL   () { return this.SERVER_BASEURL + '/app/ui/home/' },
